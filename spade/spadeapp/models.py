...
class GRB(models.Model):
    ...
    fluence90err = models.FloatField("Fluence 90 error (kev)")
    sec_peak_photon_flux = models.FloatField("1 sec peak photon flux")
    photon_index = models.FloatField("Photon index")
    photon_index_90err = models.FloatField("Photon index 90 error")
    xrtRA = models.FloatField("xrtRA")
    xrtDEC = models.FloatField("xrtDEC")
    xrt_90radius = models.FloatField("xrt 90 radius error")
